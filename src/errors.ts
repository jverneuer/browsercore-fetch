...
export class FetchTimeoutError extends FetchError {
    public override readonly kind = "FetchTimeoutError" as const;
    public readonly timeoutMs: number;

    constructor(timeoutMs: number, options?: { cause?: Error; url?: string; requestId?: FetchRequestId }) {
...
export class RedirectError extends FetchError {
    public override readonly kind = "RedirectError" as const;
...
export class ProtocolError extends FetchError {
    public override readonly kind = "ProtocolError" as const;
...
export class AbortError extends FetchError {
    public override readonly kind = "AbortError" as const;
