...
export function createPool(
    ...
    return {
        ...
        async drain(): Promise<void> {
            ...
            idleTimers.clear();
            // Close connections sequentially: each close is a protocol teardown
            // that must complete before the next starts to avoid races on shared
            // state. Parallelism would not speed this up meaningfully.
